...
/* ── Skill card variant — neeche se aayega with stagger ── */
...
/* ── Skill data array — icons alag rakh ke code clean kiya ── */
const skillsData = [
  {
    name: "HTML",
    icon: (
  ...
  },
  {
    ...
    icon: (
      <svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" viewBox="0 0 48 48">
        <path fill="#38BDF8" d="M24 16c-4 0-6 2-8 6 2-2 4-3 6-3 2 0 3 1 5 3 2 2 4 3 7 3 4 0 6-2 8-6-2 2-4 3-6 3-2 0-3-1-5-3-2-2-4-3-7-3z" />
        <path fill="#0EA5E9" d="M16 24c-4 0-6 2-8 6 2-2 4-3 6-3 2 0 3 1 5 3 2 2 4 3 7 3 4 0 6-2 8-6-2 2-4 3-6 3-2 0-3-1-5-3-2-2-4-3-7-3z" />
      </svg>
    ),
  },
  {
  ...
  },
  {
    name: "React",
    icon: (
      <svg width="70" height="70" viewBox="0 0 841.9 595.3" xmlns="http://www.w3.org/2000/svg">
  ...
  },
  {
    ...
    icon: (
      <svg width="70" height="70" viewBox="0 0 200 200">
        ...
        <path fill="#fff" d="M100 50c5 10-5 15-5 25s10 10 10 20-10 15-20 25c15-5 30-15 30-30 0-10-10-15-10-25s10-10-5-15z" />
        <text x="100" y="160" fontSize="28" fill="#fff" textAnchor="middle" fontWeight="bold">Java</text>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="70" height="70" viewBox="0 0 200 200">
        ...
        <text x="100" y="160" fontSize="24" fill="#fff" textAnchor="middle" fontWeight="bold">Data</text>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="70" height="70" viewBox="0 0 200 200">
        ...
        <text x="100" y="170" fontSize="26" fill="#fff" textAnchor="middle" fontWeight="bold">OOP</text>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="70" height="70" viewBox="0 0 200 200">
        ...
        <text x="100" y="160" fontSize="28" fill="#fff" textAnchor="middle" fontWeight="bold">Py</text>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="70" height="70" viewBox="0 0 200 200">
        ...
        <text x="100" y="165" fontSize="20" fill="#fff" textAnchor="middle" fontWeight="bold">Clone</text>
      </svg>
    ),
  },
  {
    ...
    icon: (
      <svg width="70" height="70" viewBox="0 0 256 256" xmlns="http://www.w3.org/2000/svg">
        ...
        <path d="M80 170V90l70 80V90h26v80l-70-80v80z" fill="#fff" />
      </svg>
    ),
  },
];
...
const Skills = () => {
  ...
  // ✅ Alag ref skills grid ke liye — cards jab grid view mein aaye tab animate hon
  const { ref: gridRef, inView: gridInView } = useScrollInView(0.05);
  ...
  return (
    ...
    >
      <div className={styles.skillsContainer}>
        ...
        {/* ── Header — ScrollReveal se neeche se aayega ── */}
        ...
        {/* ── Skills Grid — har card stagger ke saath aayega ── */}
