...
const highlights = [
  {
    ...
    description: "990+ LeetCode problems solved & algorithm challenges",
    color: "primary",
  },
  {
    icon: <Shield />,
    title: "Frontend & Security Enthusiast",
    description: "React, Tailwind CSS & basic pentesting knowledge",
    color: "accent",
  },
  {
    icon: <Code />,
    title: "Software Developer",
    description: "Python, JavaScript, HTML/CSS & Website Cloning",
    color: "warning",
  },
];
...
function About() {
  ...
  <div className="terminal-body">
    ...
    <span className={styles.outputSection}>
      <span className={styles.outputKey}>Name:</span> Manzoor Ali<br />
    ...
    <span className="terminal-output">
      "Code, create, and solve problems with passion."
      <br />— Manzoor Ali
    </span>
  </div>
</div>
          ...
          >
            ...
            >
              <p className={styles.bio}>
                I'm Manzoor Ali — a Software Engineer & Frontend Developer. I
                build modern, responsive, and user-friendly web applications. I
                also specialize in website cloning, React development, and UI/UX
                design. Passionate about creating clean code, scalable projects,
